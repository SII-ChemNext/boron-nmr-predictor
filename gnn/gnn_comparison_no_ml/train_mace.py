"""Train the MACE ablation without prior ML features."""
...
from model_mace import BoronMACEWithoutPriorML  # noqa: E402
...
def main():
    ...
    run_experiment(
        model_name="BoronMACE_WithoutPriorML",
        model_class=BoronMACEWithoutPriorML,
