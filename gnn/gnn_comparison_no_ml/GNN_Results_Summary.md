...
The 2D models use the virtual-node dataset without prior ML features. The three
...
| EGNN, PaiNN, MACE | one optimized 3D conformer, 5.0 Å radius graph, 32 Gaussian RBFs | batch 16, lr 0.0003, max 150 epochs, patience 30 |
