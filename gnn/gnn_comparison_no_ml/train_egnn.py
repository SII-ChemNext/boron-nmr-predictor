"""Train the fixed-coordinate EGNN ablation without prior ML features."""
...
from model_egnn import BoronEGNNWithoutPriorML  # noqa: E402
...
def main():
    ...
    run_experiment(
        model_name="BoronEGNN_WithoutPriorML",
        model_class=BoronEGNNWithoutPriorML,
