...
from models.model_v2 import BoronNMRNet_V2
...
# 1. Configuration
# =============================================================================
MODEL_NAME = "BoronNMRNet_V2"
LOG_FILENAME = "training_v2_log.txt"
...
if __name__ == "__main__":
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(dev_dataset_list)):
        ...
        for epoch in range(1, EPOCHS + 1):
            ...
            if val_mae < best_res['mae']:
                ...
                torch.save(model.state_dict(), f"model_v2_fold_{fold+1}.pth")
    ...
    for fold in range(K_FOLDS):
        ...
        try:
            m.load_state_dict(torch.load(f"model_v2_fold_{fold+1}.pth",
