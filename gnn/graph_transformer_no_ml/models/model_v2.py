...
class BoronNMRNet_V2(nn.Module):
    """
    ...
    def __init__(self, node_in_dim, edge_in_dim,
        ...
        # [Added] Virtual node update MLP (one per layer)
        ...
        # 3. Prediction head
        # ========================================
        fusion_dim = hidden_dim + solvent_dim  # 256 + 64
    ...
    def forward(self, x, edge_index, edge_attr, solvent_ids, mask_b, batch_index,
        ...
        # ========================================
        # C. Extract boron atom features + fuse solvent
        # ========================================
        b_features = x[mask_b]
