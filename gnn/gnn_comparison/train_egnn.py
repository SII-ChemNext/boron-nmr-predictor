"""Train the fixed-coordinate EGNN with Top-20 prior ML feature fusion."""
...
from model_egnn import BoronEGNN  # noqa: E402
...
def main():
    ...
    run_experiment(
        model_name="BoronEGNN_FixedCoordinates",
        model_class=BoronEGNN,
        model_kwargs=model_config,
        experiment_dir=SCRIPT_DIR,
        data_dir=args.data_dir.expanduser().resolve(),
        config=config,
        output_dir=SCRIPT_DIR / "egnn_results" / args.run_name,
    )
