"""Train EquiformerV2 with Top-20 prior ML feature fusion."""
...
from model_equiformer_v2 import BoronEquiformerV2  # noqa: E402
...
def main():
    ...
    run_experiment(
        model_name="BoronEquiformerV2_NodeScalar",
        model_class=BoronEquiformerV2,
