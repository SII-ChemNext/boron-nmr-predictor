...
from models.model_pna import BoronNMRNet_PNA
...
# 1. Configuration
# =============================================================================
MODEL_NAME = "BoronNMRNet_PNA_MLFusion"
LOG_FILENAME = "pna_results/logs/training_log.txt"
...
# PNA special configuration: load degree histogram
PNA_DEG = torch.load('pna_deg_histogram.pt', weights_only=False)
