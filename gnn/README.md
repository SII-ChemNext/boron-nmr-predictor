...
2D message-passing baselines and three 3D equivariant architectures. Both the
...
│   ├── models/                  # 2D models + EGNN, PaiNN, MACE
...
│   ├── models/                  # Includes three no-ML equivariant wrappers
│   ├── train_*.py
...
The three equivariant models require a separate 3D dataset. This command reads
