...
ALLOWED_ATOMS = [
    ...
    # --- Other elements from the dataset (alphabetical order) ---
...
# ==========================================
# 3. Core feature extraction functions
# ==========================================
...
def get_atom_features(atom):
    ...
    # ---------------------------------------------------------
    # Feature 9: Gasteiger partial charge (electron density)
    # ---------------------------------------------------------
    try:
        # Attempt to retrieve pre-computed charge (must be calculated on the molecule beforehand)
        # Default to 0.0 if retrieval fails
        charge = float(atom.GetProp('_GasteigerCharge'))

        # Charges are typically between -0.5 and +0.5; check for NaN/Inf
...
def get_bond_features(bond):
    ...
    # Distant electron-withdrawing groups can directly affect
...
def get_solvent_features(solvent_smiles):
    ...
    # Captures functional group information of the solvent
